...
public class Consulta {
	...
	//Inclua o método estático obterProdutosPorPrecoMinimo que recebe uma lista de produtos e um preço mínimo. 
	...
	public static List<Produto> obterProdutosPorPrecoMinimo(List<Produto> produtos, int precoMinimo) {
		...
		return produtos.stream().filter(p -> p.getPreco() >= precoMinimo)
				.collect(Collectors.toList());
	}
