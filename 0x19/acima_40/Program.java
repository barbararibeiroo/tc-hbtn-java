...
public class Program {
	public static void main(String[] args) {
		...
		Map<String, List<Pessoa>> pessoas2 = ConsultaPessoas
				.obterPessoasPorCargoAcimaDe40anos(List.of(pessoa1, pessoa4, pessoa10));
		Map<String, List<Pessoa>> pessoas3 = ConsultaPessoas
				.obterPessoasPorCargoAcimaDe40anos(List.of(pessoa4, pessoa9));
